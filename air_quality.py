...
params = {
	"latitude": 52.52,
	"longitude": 13.41,
	"hourly": ["pm10", "pm2_5", "carbon_monoxide", "carbon_dioxide", "sulphur_dioxide", "methane", "dust", "total_elementary_carbon"],
	"forecast_hours": 6,
	"past_hours": 6,
}
...
hourly_data["total_elementary_carbon"] = hourly_total_elementary_carbon
